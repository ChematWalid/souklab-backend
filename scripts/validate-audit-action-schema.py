...
migration = Path("src/main/resources/db/migration/V14__phase10_financial_audit_actions.sql").read_text()
...
if missing:
    raise SystemExit("audit actions missing from V14 enum: " + ", ".join(missing))
