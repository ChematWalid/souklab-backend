...
public interface ActivityEventRepository extends JpaRepository<ActivityEvent, String> {
    ...
    long countDistinctArtisanActorsByTypeAndEventTimeBetween(@Param("eventType") String eventType,
    ...
    long countDistinctClientActorsByTypeAndEventTimeBetween(@Param("eventType") String eventType,
                                                              @Param("from") LocalDateTime from,
                                                              @Param("to") LocalDateTime to);
    ...
    long countDistinctActorsByTypeAndEventTimeBetween(@Param("eventType") String eventType,
                                                       @Param("from") LocalDateTime from,
                                                       @Param("to") LocalDateTime to);
    List<ActivityEvent> findByEventTypeAndEventTimeBetweenOrderByEventTimeAsc(String eventType,
                                                                                LocalDateTime from,
                                                                                LocalDateTime to);
