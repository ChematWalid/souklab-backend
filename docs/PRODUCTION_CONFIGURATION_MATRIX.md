...
| API rate limiting | `APP_RATE_LIMIT_*` | `app.rate-limit.*` | `AppProperties.RateLimit`, `RateLimitFilter` | Bounded Caffeine cache; shared limiter required before horizontal scaling |
