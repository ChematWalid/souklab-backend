...
Postman scenarios documented in `docs/POSTMAN_API_REFERENCE.md`.
...
- `docs/POSTMAN_API_REFERENCE.md` — admin, analytics, and phase acceptance
  examples.
- `docs/PHASE10_VERIFICATION.md` — local Docker-backed evidence and scope
  boundary.
- `docs/RELEASE_CHECKLIST.md` — production/CI release gates.
- `docs/PHASE10_DEFERRED_RELEASE_PLAN.md` — future-agent execution plan for
